    ...
    return (
        <div className='flex flex-col gap-6'>
            ...
            <div className='py-4 border-b border-gray-200 flex items-center justify-between'>
                ...
                <div className='text-sm p-4 rounded-md text-blue-800 bg-blue-200 italic'>Sau khi xác nhận gia hạn, vui lòng chủ trọ hãy bank tiền gia hạn theo <a target='_blank' className='text-blue-500 hover:underline' href='http://zalo.me/0961327504'>tài khoản này</a> để admin duyệt nhé ~</div>
                        ...
                        : posts?.map((item, index) => {
                            return (
                                <tr className='text-center' key={item.id}>
                                    <td className='text-center py-4 border-b'>{index + 1}</td>
