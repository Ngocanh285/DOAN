...
const Search = () => {
    ...
    return (
        <>
            <div className='p-[8px] w-3/5 my-2 bg-[#84b642] rounded-lg flex-col lg:flex-row flex items-center justify-around gap-2' >
                ...
                <button
                    ...
                    className='outline-none py-2 px-4 flex-1 bg-[#1ba65d] text-[13.3px] flex items-center justify-center gap-2 text-white font-medium'
                >
                    <FiSearch />
                    Tìm kiếm
                </button>
